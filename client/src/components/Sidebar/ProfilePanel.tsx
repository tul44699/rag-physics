...
export default function ProfilePanel() {
  ...
  const handleSave = useCallback(async () => {
    await saveProfile({ understanding_level: level, learning_style: learningStyle, course });
    setOpen(false);
    ...
    <div className={styles.panel}>
      ...
      {open && (
        <div className={styles.body}>
          ...
          <label className={styles.field}>
            Style
            <select value={learningStyle} onChange={(e) => setLearningStyle(e.target.value)} className={styles.input}>
          ...
          <label className={styles.field}>
            ...
            <input value={course} onChange={(e) => setCourse(e.target.value)}
              className={styles.input} placeholder="e.g. Physics II" />
          </label>
